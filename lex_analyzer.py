...
class Lexer(object):
    ...
    'CORCHETE_TERMINA', 'PUNTOS_DOBLES', 'PUNTO_COMA', 'PUNTO', 'COMA', 'FIN', 'DE', 'PROGRAMA', 'FUNCION', 'PROCEDIMIENTO', 'INICIO',  'Y', 'O', 'NO', 'MAS', 'MENOS', 'MULTI', 'DIV', 'MOD', 'POTENCIA', 'VERDADERO', 'FALSO', 'HASTA',
    'PROTOTIPOS', 'INCR', 'DECR')

    estatutos = ('LIMPIA',
    'SI', 'DESDE', 'REPETIR', 'MIENTRAS', 'CUANDO', 'REGRESA', 'IMPRIME', 'IMPRIMENL', 'LEE', 'INTERRUMPE', 'CONTINUA', 'HACER', 'SINO', 'EL',
    'VALOR',  'QUE', 'SE', 'CUMPLA', 'SEA', 'OTRO')
